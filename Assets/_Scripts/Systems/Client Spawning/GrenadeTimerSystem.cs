...
public partial struct GrenadeLauncherRotateSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (camera, anchorPoint) in SystemAPI.Query<OrbitCamera, RefRO<AnchorPoint>>().WithAll<Simulate>())
        {
            ...
            var followCameraRotation = quaternion.RotateX(-camera.PitchAngle);
